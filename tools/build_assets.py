#!/usr/bin/env python3
"""Generate branded icon + fanart for Kodi-AI add-on and repository.

Outputs (deterministic, regenerated from this script):
- service.kodi.ai/icon.png   (256x256 — addon listing icon)
- service.kodi.ai/fanart.jpg (1920x1080 — fullscreen background)
